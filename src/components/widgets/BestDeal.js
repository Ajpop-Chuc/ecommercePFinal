   ...
   constructor(props) {
      ...
      this.state = {
         productData: {
            ...
            previewImage: require("../../assets/images/men/1-item-a.jpg").default,
            price: 42.75,
            sellingPrice: '36.00',
            ...
            time: 50000,
            productImages: [
               require("../../assets/images/men/1-item-a.jpg").default,
               require("../../assets/images/men/1-item-b.jpg").default,
               require("../../assets/images/men/1-item-c.jpg").default
            ]
         }
      }
   }
