                     ...
                     <CardActionArea>
                        <div className="iron-overlay-wrap">
                           <div className="iron-thumb-wrap">
                              <img src={require("../../assets/images/sale-1.jpg").default} width="640" height="430" alt="SaleCallInAction" />
                           </div>
               ...
               <div className="iron-post-item">
                  <Link to="/shop" className="d-block">
                     <CardActionArea>
                        <div className="iron-overlay-wrap">
                           <div className="iron-thumb-wrap">
                              <img src={require("../../assets/images/sale-2.jpg").default} width="640" height="430" alt="SaleCallInAction" />
                           </div>
               ...
               <div className="iron-post-item">
                  <Link to="/shop" className="d-block">
                     <CardActionArea>
                        <div className="iron-overlay-wrap">
                           <div className="iron-thumb-wrap">
                              <img src={require("../../assets/images/sale-3.jpg").default} width="640" height="430" alt="SaleCallInAction" />
                           </div>
